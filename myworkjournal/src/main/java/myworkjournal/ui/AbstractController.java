...
public abstract class AbstractController {
  ...
  @FXML protected void saveDataAndClose() throws FileNotFoundException {
    if (loggedInEmployee == null) {
      throw new IllegalArgumentException("Employee to save is not defined");
    }
    DataSaverInterface<Employee> employeeSaver =
  ...
  @FXML protected void showPopup() {
    popupPane.setVisible(true);
  }

  @FXML protected void closePopup() {
    popupPane.setVisible(false);
  }

  @FXML private void closeDeletePopup() {
    deletePopupPane.setVisible(false);
  }

  @FXML private void showDeletePopup() {
