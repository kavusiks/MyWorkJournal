...
public class CreateProfileController extends AbstractController {
  @FXML TextField profileNameInputField;

  @FXML Button createProfileBtn;

  @FXML TextField savedUserDisplayField;

  @FXML Button savedUserLoginBtn;
  ...
  @FXML private void createProfile() throws IOException {
  ...
  @FXML private void goToAddWorkPeriod() throws IOException {
  ...
  @Override void sceneSwitchedUpdate() {
    try {
      DataSaverInterface<Employee> employeePersistence =
          new EmployeePersistence("src/main/resources/myworkjournal/persistence/employee.txt");
