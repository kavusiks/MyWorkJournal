...
public class EmployeePersistenceTest extends AbstractPersistenceTest implements PersistenceTestInterface {
  ...
  @Test @Override public void testConstructor() {
    ...
    assertNotNull(employeePersistence, "The employeePersistence was not created properly.");
    assertEquals(testData.getEmployee(), testData.getEmployee(),
        "The employeePersistence with employee was created, but it doesn't contain the correct employee.");
  ...
  @Test @Override public void testWriteAndReadFile() {
    ...
    assertThrows(FileNotFoundException.class, () -> readEmployee = employeePersistence.readFile(),
  ...
  @Test public void testWriteAndReadWithSingleWorkPeriod() {
  ...
  @Test public void testWriteAndReadWithMultipleWorkPeriods() {
    //Testing with multiple workPeriods in workPeriods-hashmap
    testData.getEmployee().addWorkPeriod(testData.getThisMonthWorkPeriod());
    WorkPeriod nextMonthWorkPeriod =
