...
public class WorkTest {
  ...
  @Test public void testConstructor() {
    ...
    try {
      ...
      assertEquals(testData.getValidStartTime().truncatedTo(MINUTES), work.getStartTime(),
          "Expected starttime and actual starttime doesn't match.");
      assertEquals(testData.getValidEndTime().truncatedTo(MINUTES), work.getEndTime(),
          "Expected starttime and actual starttime doesn't match.");
    } catch (Exception e) {
      fail("A valid work couldn't be created. Following starttime  " + testData.getValidStartTime()
          + " and following endtime " + testData.getValidEndTime() + " was used.");
    }
  ...
  @Test public void testGetHours() {
    work = new Work(testData.getValidStartTime(), testData.getValidEndTime());
    assertEquals(testData.getShiftDurationHours(), work.getShiftDurationInHours(),
        "Expected shift duration and actual shift duration doesn't match.");
    ...
    assertEquals(testData.getShiftDurationHours(), work.getShiftDurationInHours(),
        "Expected shift duration and actual shift duration doesn't match for overnight shifts.");
  ...
  @Test public void testToString() {
    work = new Work(testData.getValidStartTime(), testData.getValidEndTime());
    assertEquals(
        testData.getValidStartTime().truncatedTo(MINUTES).toLocalDate() + " kl: " + testData.getValidStartTime()
            .truncatedTo(MINUTES).toLocalTime() + " - " + testData.getValidEndTime().truncatedTo(MINUTES).toLocalDate()
            + " kl: " + testData.getValidEndTime().truncatedTo(MINUTES).toLocalTime(), work.toString());
  }
